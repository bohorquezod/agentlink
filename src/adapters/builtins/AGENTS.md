...
| `cursor.ts` | `cursor` | `.cursor/rules/AGENTS.md` | `.cursor/skills/` | — | — | [Cursor docs](https://cursor.com/docs/context/rules) |
...
- `rootDocs` always maps `AGENTS.md` as the source. The target varies per IDE (e.g. `CLAUDE.md`, `.cursor/rules/AGENTS.md`).
